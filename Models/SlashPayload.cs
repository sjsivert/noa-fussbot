...
// Probably don't need anything below ___
    public partial class SlashPayload
    {
        public static SlashPayload FromJson(string json) => JsonConvert.DeserializeObject<SlashPayload>(json, Converter.Settings);
    }

    public static class Serialize2
    {
        public static string ToJson(this SlashPayload self) => JsonConvert.SerializeObject(self, Converter.Settings);
    }
